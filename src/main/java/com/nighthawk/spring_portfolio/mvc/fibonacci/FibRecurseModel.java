...
public class FibRecurseModel extends FibAbstractModel {
    public FibRecurseModel() {
        super();
    }
    public FibRecurseModel(int nth) {
        super(nth);
    }
    ...
    */
    ...
    public static void main(String[] args) {
        FibAbstractModel fibonacci = new FibRecurseModel();  // "FibRecurse" is used as initializer for the "_Fibonacci fibonacci"  object
        fibonacci.print();
    }
}